...
replacing $ \partial_{\mu} \partial_{\nu} h^{\mu \nu} $ with $ \partial_{\gamma}B^{\gamma} $
\begin{equation}
\( \partial_{\gamma} B^{\gamma} +\frac{3}{4} Y \)
\end{equation}

\item{Includes a term that shouldn't be replaced}\\
...
\item{can replace either derivative}\\
...
\item{must replace the derivative with the sum}\\
...
replacing $ \partial_{\nu} h^{\mu \nu} $ with $ B^{\mu} $
\begin{equation}
\( \partial_{\gamma} B^{\mu} +\frac{3}{4} Y \)
\end{equation}

\item{must replace the derivative without the sum}\\
...
{\color{red}
\item{replacing a number of derivatives}\\
...
replacing $ \partial_{\mu} \partial_{\nu} h^{\mu \nu} $ with $ B^{\mu}_{\mu} $
\begin{equation}
A^{\zeta} \square M_{\zeta} B_{\mu}^{\mu}
\end{equation}
...
replacing $ \partial_{\nu} h^{\mu \nu} $ with $ B^{\mu} $
\begin{equation}
A^{\zeta} \square M_{\zeta} \partial_{\gamma} B^{\mu}
\end{equation}
